...
import com.grallopmark.tablayout.utils.FragmentChangeManager;
...
//        mTabPadding = ta.getDimension(R.styleable.CommonTabLayout_tl_tab_padding, mTabSpaceEqual || mTabWidth > 0 ? dp2px(0) : dp2px(10));
    ...
    public void setTabData(@NonNull List<CustomTabEntity> tabEntities) {
     ...
     * 关联数据支持同时切换fragments
     */
    public void setTabData(List<CustomTabEntity> tabEntities, FragmentActivity fa, int containerViewId, ArrayList<Fragment> fragments) {
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            tabView.setPadding((int) mTabPaddingStart, (int) mTabPaddingTop, (int) mTabPaddingEnd, (int) mTabPaddingBottom);
            TextView tv_tab_title = tabView.findViewById(R.id.tv_tab_title);

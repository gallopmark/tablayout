...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private float mTabPaddingStart;
    private float mTabPaddingEnd;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorHeight = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_height,
                DensityUtil.dp2px(context, mIndicatorStyle == STYLE_TRIANGLE ? 4 : (mIndicatorStyle == STYLE_BLOCK ? -1 : 2)));
        mIndicatorWidth = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_width, DensityUtil.dp2px(context, mIndicatorStyle == STYLE_TRIANGLE ? 10 : -1));
        mIndicatorCornerRadius = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_corner_radius, DensityUtil.dp2px(context, mIndicatorStyle == STYLE_BLOCK ? -1 : 0));
        mIndicatorMarginLeft = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_margin_left, 0);
        mIndicatorMarginTop = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_margin_top, DensityUtil.dp2px(context, mIndicatorStyle == STYLE_BLOCK ? 7 : 0));
        mIndicatorMarginRight = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_margin_right, 0);
        mIndicatorMarginBottom = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_margin_bottom, DensityUtil.dp2px(context, mIndicatorStyle == STYLE_BLOCK ? 7 : 0));
        ...
        mDividerPadding = ta.getDimension(R.styleable.SlidingTabLayout_tl_divider_padding, DensityUtil.dp2px(context, 12));
        mTextSize = ta.getDimension(R.styleable.SlidingTabLayout_tl_textSize, DensityUtil.sp2px(context, 14));
        mTextSelectedColor = ta.getColor(R.styleable.SlidingTabLayout_tl_textSelectColor, Color.parseColor("#ffffff"));
        mTextUnselectedColor = ta.getColor(R.styleable.SlidingTabLayout_tl_textUnselectColor, Color.parseColor("#AAffffff"));
        ...
        mTabWidth = ta.getDimension(R.styleable.SlidingTabLayout_tl_tab_width, DensityUtil.dp2px(context, -1));
        mTabPaddingStart = ta.getDimension(R.styleable.SlidingTabLayout_tl_tab_paddingStart, mTabSpaceEqual || mTabWidth > 0 ? 0 : 0);
        mTabPaddingEnd = ta.getDimension(R.styleable.SlidingTabLayout_tl_tab_paddingEnd, mTabSpaceEqual || mTabWidth > 0 ? 0 : 0);
        mTabPaddingTop = ta.getDimension(R.styleable.SlidingTabLayout_tl_tab_paddingTop, mTabSpaceEqual || mTabWidth > 0 ? 0 : 0);
        mTabPaddingBottom = ta.getDimension(R.styleable.SlidingTabLayout_tl_tab_paddingBottom, mTabSpaceEqual || mTabWidth > 0 ? 0 : 0);
        mTabPadding = ta.getDimension(R.styleable.SlidingTabLayout_tl_tab_padding, mTabSpaceEqual || mTabWidth > 0 ? 0 : 0);
        if (mTabPadding != 0) {
            mTabPaddingStart = mTabPadding;
            mTabPaddingEnd = mTabPadding;
    ...
    public void setupViewPager(@NonNull ViewPager vp) {
        setupViewPager(vp, new String[0]);
    }

    /**
     * 关联ViewPager,用于不想在ViewPager适配器中设置titles数据的情况
     */
    public void setupViewPager(@NonNull ViewPager vp, @NonNull String[] titles) {
        this.mViewPager = vp;
        if (mViewPager.getAdapter() == null) {
            mViewPager.setAdapter(new DefaultPagerAdapter(titles.length));
        }
        if (titles.length != mViewPager.getAdapter().getCount()) {
     ...
     */
    public void setupViewPager(@NonNull ViewPager vp, @NonNull String[] titles, FragmentActivity fa, ArrayList<Fragment> fragments) {
        this.mViewPager = vp;
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                ...
                tv_tab_title.setPadding((int) mTabPaddingStart, (int) mTabPaddingTop, (int) mTabPaddingEnd, (int) mTabPaddingBottom);
...
//        scrollToCurrentTab();
    ...
    public void setTabPaddingStart(float tabPaddingStart) {
        this.mTabPaddingStart = tabPaddingStart;
        updateTabStyles();
    }

    public void setTabPaddingEnd(float tabPaddingEnd) {
    ...
    public void setTabPadding(float tabPaddingStart, float tabPaddingTop, float tabPaddingEnd, float tabPaddingBottom) {
        this.mTabPaddingStart = tabPaddingStart;
        this.mTabPaddingTop = tabPaddingTop;
        this.mTabPaddingEnd = tabPaddingEnd;
        this.mTabPaddingBottom = tabPaddingBottom;
    ...
    public float getTabPaddingStart() {
        return mTabPaddingStart;
    }

    public float getTabPaddingEnd() {
